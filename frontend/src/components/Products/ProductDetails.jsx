...
const ProductDetails = ({ data }) => {
  ...
  const handleMessageSubmit = () => {
    navigate("/inbox?conversation=7346gyf877398ufye8");
  };
              ...
              <div className="w-full 800px:w-[50%]">
                ...
                >
                  <span className="text-white flex items-center">
                    Add to cart <TiShoppingCart size={20} className="!ml-2" />
                  </span>
                </div>
                <div className="flex items-center pt-8">
                  ...
                  >
                    <span className="text-white flex items-center">
                      Send Message{" "}
                      <TbMessage2Share size={20} className="ml-2" />
                    </span>
                  </div>
                </div>
              </div>
      ...
      {active === 1 ? (
        <>
          <p className="py-2 text-[18px] leading-8 pb-10 whitespace-pre-line">
            ...
            make an informed decision about the product they are interseted in
          ...
          <p className="py-2 text-[18px] leading-8 pb-10 whitespace-pre-line">
            ...
            product, as well as customer reviews and ratings. When writting
        ...
        <div className="w-full block 800px:flex p-5">
          <div className="w-full 800px:w-[50%]">
            ...
            <p className="pt-2">
              ...
              vero iste repudiandae fuga quam maxime ut quae. Asperiores, cum
              sequi quia voluptas explicabo distinctio inventore cupiditate
              maxime facilis vitae.
            </p>
          </div>
          <div className="w-full 800px:w-[50%] mt-5 800px:mt-0 800px:flex flex-col items-end">
            <div className="text-left">
                <h5 className="font-[600]">
                    Joined on: <span className="font-[500]">22nd December 2023</span>
                </h5>
